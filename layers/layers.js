...
lyr_jalan_1.set('fieldAliases', {'id': 'id', 'Jln Utama': 'Jln Utama', });
...
lyr_jalan_1.set('fieldImages', {'id': 'TextEdit', 'Jln Utama': 'TextEdit', });
...
lyr_jalan_1.set('fieldLabels', {'id': 'no label', 'Jln Utama': 'no label', });
